...
const heightEasy = '170-180 cm';
const heightMedium = '180-190 cm';
const heightHard = '190-200 cm';
const jumpEasy = '30-40 cm';
const jumpMedium = '40-50 cm';
const jumpHard = '50-60 cm';
...
const URL_LEAGUE_API = 'http://165.22.26.62/api/auth/leagues';
const URL_CLUBS_API = 'http://165.22.26.62/api/auth/clubs/league/';
//const accessToken =
...
const kPlayerParamTextStyle = TextStyle(fontFamily: 'BarlowCondensed', fontSize: 30.0);

const kPlayerParamDisabled = Text(
  '-',
  style: TextStyle(fontSize: 30.0, fontFamily: 'BarlowCondensed', color: Color(0xFF707070)),
);
