...
const kPlayerParamTextStyle = TextStyle(fontFamily: 'BarlowCondensed', fontSize: 20.0);

const kPlayerParamDisabled = Text(
  '-',
  style: TextStyle(fontSize: 20.0, fontFamily: 'BarlowCondensed', color: Color(0xFF707070)),
);
